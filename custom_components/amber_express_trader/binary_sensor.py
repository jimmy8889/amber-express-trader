"""Binary sensor platform for Amber Express Trader integration."""
...
class AmberBinarySensorDescription(BinarySensorEntityDescription):
    """Describes an Amber Express Trader binary sensor entity."""
...
async def async_setup_entry(
    ...
    """Set up Amber Express Trader binary sensors for all site subentries."""
