...
from custom_components.amber_express_trader.select import PollingStrategySelect, PricingModeSelect, async_setup_entry
...
async def test_pricing_mode_select_device_info(hass: HomeAssistant) -> None:
    ...
    assert entity.device_info["name"] == "Amber Express Trader - Test Site"
...
async def test_async_setup_entry_adds_entities_for_site_subentry(
    ...
    """Test setup adds configuration selects for matching site subentries."""
    ...
    assert isinstance(entities[1], PollingStrategySelect)
