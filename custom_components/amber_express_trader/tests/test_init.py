...
from custom_components.amber_express_trader import async_setup_entry, async_unload_entry, async_update_listener
...
from custom_components.amber_express_trader.repairs import (
...
class TestAsyncSetupEntry:
    ...
    async def test_setup_entry_success(
        ...
        with (
            patch("custom_components.amber_express_trader.AmberDataCoordinator") as mock_coordinator_class,
            patch("custom_components.amber_express_trader.AmberWebSocketClient") as mock_ws_class,
...
class TestAsyncUnloadEntry:
    ...
    async def test_unload_entry_success(
        ...
        from custom_components.amber_express_trader import AmberRuntimeData, SiteRuntimeData  # noqa: PLC0415
