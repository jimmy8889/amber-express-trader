...
from custom_components.amber_express_trader.api import ExponentialBackoffRateLimiter
...
class TestIsLimited:
    ...
    def test_limited_when_rate_limit_active(self) -> None:
        ...
        with patch("custom_components.amber_express_trader.api.rate_limiter.datetime") as mock_datetime:
