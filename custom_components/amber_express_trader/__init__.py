"""Amber Express Trader integration for Home Assistant."""
...
class AmberRuntimeData:
    """Runtime data for Amber Express Trader integration."""
...
async def async_setup_entry(hass: HomeAssistant, entry: AmberConfigEntry) -> bool:
    """Set up Amber Express Trader from a config entry."""
...
async def async_update_listener(hass: HomeAssistant, entry: AmberConfigEntry) -> None:
    ...
    _LOGGER.info("Amber Express Trader configuration changed, reloading integration")
